...
export default function VoiceIntake({ onSubmitDraft, onUseText }) {
  ...
  return (
    <section className="voice-intake" aria-labelledby="voice-intake-title">
      ...
      <p className="voice-disclosure">Voice audio is sent to Google Gemini for this live session. The application does not retain your audio or unfinished transcript.</p>
    </section>
  );
}