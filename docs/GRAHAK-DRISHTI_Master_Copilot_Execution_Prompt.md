...
- docs/IMPLEMENTATION_AUDIT.md if it exists
- docs/GRAHAK-DRISHTI_POC_STABILIZATION_PLAN.md if it exists in the repository
...
2. docs/GRAHAK-DRISHTI_POC_STABILIZATION_PLAN.md
3. docs/PRD.md
...
Do not implement infrastructure merely because it exists in docs/ARCHITECTURE.md.
